    ...
    <div class="container-fluid nav-index">
      ...
      <div class="row">
        ...
        <div class="col-sm-10 col-md-10 col-lg-10 col-xl-10">
          <fieldset class="topo" style="margin-top: 140px;">
          <legend><img src="imgs/logo.png" class="logo"></legend>
          <h4>Nossos contatos abaixo:</h4>
          <label>
            <ul>
              <li>E-mail: kyrotth@gmail.com</li>
              <li>Facebook: <a href="https://www.facebook.com/feligabriel.sant">Gabriel</a></li>
              <li>Facebook: <a href="https://www.facebook.com/enos.fernandes.58">Enos</a></li>
              <li>Facebook: <a href="https://www.facebook.com/natan.goncalves.9237">Natan</a></li>
            </ul>
          </label>
          </fieldset>
        </div>
