    ...
    <div class="container-fluid nav-index">
      ...
      <div class="row first">
        ...
        <label class="ficha col-sm-10 col-md-10 col-lg-10 col-xl-10">
          <fieldset>
            <legend>
            <img src="imgs/felix.png" class="imgficha" alt="Felix"><p></p>
            <img src="imgs/gabriel.png"><p></p>
      ...
      <div class="row">
        ...
        <label class="ficha col-sm-10 col-md-10 col-lg-10 col-xl-10">
          <fieldset>
            <legend>
            <img src="imgs/eu.png" class="imgficha" alt="Enos"><p></p>
            <img src="imgs/enos.png"><p></p>
      ...
      <div class="row">
        ...
        <label class="ficha col-sm-10 col-md-10 col-lg-10 col-xl-10">
          <fieldset>
            <legend>
            <img src="imgs/natan.png" class="imgficha" alt="Natan"><p></p>
            <img src="imgs/natann.png"><p></p>
